...
class PLLexp1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Addtive Noise", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Addtive Noise")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PLLexp1")
        ...
        self._sigma_range = qtgui.Range(0.01, 1, 0.01, 0.5, 200)
        self._sigma_win = qtgui.RangeWidget(self._sigma_range, self.set_sigma, "sigma", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sigma_win)
        self._sig_amp_range = qtgui.Range(0.01, 1, 0.01, 0.5, 200)
        self._sig_amp_win = qtgui.RangeWidget(self._sig_amp_range, self.set_sig_amp, "sig_amp", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sig_amp_win)
        self._freq_range = qtgui.Range(0, 24000, 100, 1000, 200)
        self._freq_win = qtgui.RangeWidget(self._freq_range, self.set_freq, "'freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_win)
        self._center_range = qtgui.Range(500, 5000, 100, 1000, 200)
        self._center_win = qtgui.RangeWidget(self._center_range, self.set_center, "'center'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._center_win)
        self._BW_range = qtgui.Range(250, 5000, 100, 1000, 200)
        ...
        labels = ['Sine', 'Noise', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, freq, sig_amp, 0, 0)
        self.analog_pll_refout_cc_0 = analog.pll_refout_cc((628.319e-6), 0.131, 0.129)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, (self.center-self.BW/2), (self.center+self.BW/2), 1, window.WIN_RECTANGULAR, 6.76))
...
def main(top_block_cls=PLLexp1, options=None):
